...
import { support, footerDates, contacts } from '../constant/data';
const Footer = () => {
  return (
      ...
      <div className='container mx-auto lg:mb-24'>
        <div className='flex flex-col gap-12 lg:flex-row items-center mt-4'>
          ...
          <div className='flex flex-1 flex-col  gap-16 lg:flex-row'>
            ...
            {/* footerDates */}
            <div className='w-full text-center lg:text-left'>
              <h1 className='mb-6 text-2xl font-medium'>Footer Dates</h1>
              <ul className='space-y-4 text-xl  text-gray'>
                {footerDates.map((item, index) => {
                  return (
                    <li
                      className='transition-all duration-300 hover:text-blue'
                      key={index}
      ...
      <div className='container mx-auto flex flex-col items-center py-10 lg:flex-row lg:justify-between'>
        ...
        <div className='flex gap-x-8 text-3xl'>
          <a
            ...
            target='blank'
          >
            <BsFacebook className='transition hover:text-green-600 w-[30px] h-[30px]  cursor-pointer' />
          </a>

          <a href='https://www.instagram.com/mashalyabdallah/' target='blank'>
            <BsInstagram className='transition hover:text-green-600 w-[30px] h-[30px]   cursor-pointer' />
          </a>
          <a
            href='https://www.youtube.com/channel/UCeVSDHjRKk-rsnQlXcSksAg'
            target='blank'
          >
            <BsYoutube className='transition hover:text-green-600 w-[30px] h-[30px]   cursor-pointer' />
          </a>
          <a
            href='https://www.linkedin.com/in/abdallah-mashaly-797482250/'
            target='blank'
          >
            <BsLinkedin className='transition hover:text-green-600  w-[30px] h-[30px]  cursor-pointer' />
          </a>
        </div>
      </div>
    </footer>
